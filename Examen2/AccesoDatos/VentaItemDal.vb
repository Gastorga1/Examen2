...
Public Class VentaItemDAL
    Public Shared Function Insertar(item As VentaItem) As Boolean
        Try
    ...
    Public Shared Function BuscarPorVenta(idVenta As Integer) As List(Of VentaItem)
        Try
    ...
    Public Shared Function EliminarPorVenta(idVenta As Integer) As Boolean
        Try
